...
class Citas {
    ...
    editarCita(citaActualizada) {
        //.map nos crea un nuevo arreglo, por lo tanto sobreescribimos lo que tengamos en citas
...
class UI {
    ...
    imprimirCitas({ citas }) {
        ...
        citas.forEach(cita => {
            ...
            divCita.dataset.id = id; //le agregamos un atributo
            ...
            //Agregando los párrafos al divCita
...
function nuevaCita(e) {
    ...
    if (editando) {
        ...
        //Regresamos el texto de botón a su estado original  
